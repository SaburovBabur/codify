...
const style = {
  ...
  p: `text-gray-primary text-base md:pt-5`,
  circle: `md:w-72 w-36 h-32 md:h-64 bg-blue-700 absolute left-[-10rem] top-0 rounded-full blur-[50px] opacity-50 md:opacity-30`,
  ...
  return (
    <>
      <App className='scroll-white'>
        ...
        <App.Container className='px-3 md:px-20 space-y-20 md:space-y-40 relative'>
          <div className='relative'>
            <div className={style.circle + ` move z-10`}></div>

            <div
              className={`flex-col flex items-center justify-center space-y-10 py-16 px-7 md:px-0 md:pt-20 z-20 relative`}
            >
          ...
          <div className={`relative space-y-20`}>
            <div className='flex md:flex-row flex-col'>
              <div
                className={`w-full md:w-1/6 h-16 md:h-36 flex items-center md:justify-center shrink-0`}
              >
                <img
                  ...
                  className={`h-full`}
                />
                <h2 className={style.h2 + ` md:hidden ml-5`}>HTML</h2>
              </div>

              <div className={`md:w-5/6 shrink-0`}>
                <h2 className={style.h2 + ` hidden md:block`}>HTML</h2>

                <p className={`text-gray-primary text-sm md:text-base pt-5`}>
            ...
            <div className='grid grid-cols-2 gap-12 md:gap-0 md:grid-cols-4 | md:pt-20'>
              {[
                {
                  num: 3,
                  h1: `Module`,
                ...
                >
                  <h3
                    className={`font-bold text-4xl md:text-5xl text-gray-primary`}
                  >
                    {m.num}
                  </h3>

                  <h3
                    className={`font-bold text-3xl md:text-4xl text-gray-primary`}
                  >
                    {m.h1}
                  </h3>
                </div>
          ...
          <div className='modules | space-y-10 md:space-y-20'>
            <div className='space-y-5 md:px-10'>
              <h2
                className={`font-bold text-3xl md:text-4xl text-gray-primary uppercase`}
              >
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 | relative'>
              ...
              {[
                ...
                <ul
                  key={idx}
                  className='no_padding_top space-y-2 pl-5 py-5 md:pl-14 md:py-10 border-r border-b border-[#226EDF] border-opacity-50'
                >
                  {num.map((name, idx) => (
                    <li
                      key={idx}
                      className='text-[#226EDF] list-disc text-sm md:text-base'
                    >
                      {name}
                    </li>
                  ))}
          ...
          <div className='projects space-y-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
              {[
                ...
                <div
                  key={idx}
                  className='grid grid-cols-3 | border border-gray-primary'
                >
                  <div className='img max-h-64 col-span-1 overflow-hidden border-r border-gray-primary flex items-center justify-center'>
                    <img
                      src={p.img}
                      alt='Project Logo'
                  ...
                  <div className='col-span-2 | px-5 py-3 flex flex-col justify-evenly'>
                    <h4
                      className={`font-bold text-lg md:text-2xl text-gray-primary`}
                    >
                      {p.title}
                    </h4>
                    <p
                      className={`text-gray-primary text-sm md:text-base md:pt-5`}
                    >
                      {p.desc}
                    </p>
                  </div>
          ...
          <div className='progress | md:px-10 space-y-10'>
                      ...
                      <Disclosure.Button className='w-full outline-none focus:outline-none'>
                        <div className='module:button | border-[0.25px] fcb | cursor-pointer | px-3 py-3'>
                          <div className='fc | space-x-5'>
                            <div className='w-6 h-6 | bg-gray-primary rounded-full text-white flex items-center justify-center'>
                              1
                            </div>
          ...
          <div className='cta pb-20'>
            <div className={`flex items-center justify-center flex-col`}>
              ...
              <h3
                className={`font-bold text-3xl md:text-4xl text-gray-primary text-center md:w-4/5 pb-10 md:pb-20`}
              >
        ...
        <App.Footer className='shadow-300 py-7 px-7'>
          <Footer />
        </App.Footer>
      </App>
    </>
...
function ArticleProgressCard({ config: article, active, last }) {
  ...
  return (
    <div className='article fcb | relative | pb-3 | flex-grow'>
      ...
      {article.completed ? (
        <div className='w-6 h-6 bg-[#05F300] rounded-[3px] flex items-center justify-center relative | mr-3'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 512 512'
        ...
        <div className='w-6 h-6 bg-[#E0E0E0] rounded-[3px] flex items-center justify-center relative | mr-3'></div>
      )}
    </div>
  )
}
