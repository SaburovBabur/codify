...
function Home() {
  return (
    <App className='scroll-white'>
      ...
      <App.Container>
        <section className='flex-col fc pt-12 md:pt-20 | space-y-5 md:space-y-10 relative z-20'>
          <h1 className='text-2xl md:text-5xl font-bold | text-gray-primary | z-20 relative'>
          ...
          <h1 className='text-2xl md:text-5xl font-bold | text-gray-primary | z-20 relative text-center'>
          ...
          <div className='absolute top-1/4 right-0 h-14 md:h-20 pointer-events-none | z-10'>
            <img
        ...
        <div className='flex-row flex items-center justify-center md:space-x-10 | pt-10 md:pt-20 space-x-5'>
          <button className='relative py-2.5 md:py-3 w-2/5 md:w-1/5 font-bold text-black group outline-none focus:outline-none'>
            ...
            <span className='relative text-xs md:text-base text-white pointer-events-none | flex items-center justify-center'>
              <p>Boshlash</p>
              <svg
                viewBox='0 0 20 20'
                fill='none'
          ...
          <button className='relative py-1.5 md:py-3 w-2/5 md:w-1/5  text-gray-400 group outline-none focus:outline-none'>
            ...
            <span className='relative pointer-events-none text-xs md:text-base'>
              Ro’yxattan o’tish
            </span>
          </button>
        </div>

        <div className='courses | px-3 md:px-0 pt-12 md:pt-40'>
          <div className='available:courses'>
            <h1 className='text-xl md:text-3xl font-bold md:px-28 | text-gray-primary uppercase'>
              Kurslar:
            </h1>
          ...
          <div className='veev.uz | fc | shadow-400 px-3 py-1 rounded-md'>
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop offset='0.375' />
                  <stop offset='1' stopColor='#ABABAB' stopOpacity='0' />
                </linearGradient>
              </defs>
            </svg>
